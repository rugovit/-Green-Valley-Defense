...
public class IzbornikGlavni implements UIManagerObject {
///////////////ZASTAVICE
...
public IzbornikGlavni(SpriteHendler sprHend,UIManager uiMan,int indikator) {
	this.sprHend=sprHend;
	this.uiMan=uiMan;
	this.indikator=indikator;
	//////stvaranje crno bijelog providnog painta
	paintNekorBot= new Paint();
	paintNekorBot.setAlpha(90);
